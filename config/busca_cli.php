...
if (mysqli_affected_rows($conexao)>0) {
  ...
  while ($row=mysqli_fetch_row($result))
  {
    ...
    echo "<td style='white-space: nowrap;'>".$pessoa."</td>";
    ...
    echo "<td style='white-space: nowrap;'>".$sexo."</td>";
    echo "<td style='white-space: nowrap;'>".$row[8]."</td>";
    echo "<td style='white-space: nowrap;'>".$row[10]."</td>";
    echo "<td style='white-space: nowrap;'>".$row[11]."</td>";
    echo "<td style='white-space: nowrap;'>".$row[12]."</td>";
    echo "<td style='white-space: nowrap;'>".$row[15]."</td>";
    echo "<td style='white-space: nowrap;'>".$row[19]."</td>";
    echo "<td style='white-space: nowrap;'>".$row[13]."</td>";
    echo "<td style='white-space: nowrap;'>".$row[14]."</td>";
    echo "<td style='white-space: nowrap;'>".$tipoempresa."</td>";
    echo "<td style='white-space: nowrap;'>".$row[17]."</td>";
    echo "<td style='white-space: nowrap;'>".$row[18]."</td>";
