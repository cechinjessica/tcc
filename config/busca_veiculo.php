...
if (mysqli_affected_rows($conexao)>0) {
	...
	<table class='table table-hover table-light table-sm'>
             <thead>
			  <tr>
                <th scope='col' style='white-space: nowrap; text-align:center; text-transform: uppercase;' id='codigo'>Código</th>
                ...
                <th scope='col' style='white-space: nowrap; text-align:center; text-transform: uppercase;' id='chassi'>Chassi</th>
				...
				<th scope='col' style='white-space: nowrap; text-align:center; text-transform: uppercase;' id='renavam'>Renavam</th>
                ...
                <th scope='col' style='white-space: nowrap; text-align:center; text-transform: uppercase;' id='combustivel'>Combustível</th>
                <th scope='col' style='white-space: nowrap; text-align:center; text-transform: uppercase;' id='contrato'>Tem Contrato?</th>
    ...
    while ($row=mysqli_fetch_row($result))
    {
       ...
       // $valor = str_replace ( "." ,",", $row[10]);
        ...
        echo " <tbody>";
        echo " <tr>";
        echo "<th scope='row' style='white-space: nowrap; text-align:center;' id='codigo'>".$row[0]."</td>";
        ...
        echo "<td style='white-space: nowrap; text-align:center;' id='chassi'>".$row[5]."</td>";
        echo "<td style='white-space: nowrap; text-align:center;'>".$row[6]."</td>";
        echo "<td style='white-space: nowrap; text-align:center;'>".$row[7]."</td>";
        echo "<td style='white-space: nowrap; text-align:center;' id='renavam'>".$row[8]."</td>";
        ...
        echo "<td style='white-space: nowrap; text-align:center;' id='combustivel'>".$combustivel."</td>";
        echo "<td style='white-space: nowrap; text-align:center;' id='contrato'>".$check."</td>";
        echo "<td id='operacao'> <a href=veiculo.php?id=".$row[0]."&op=A><button type='button' class='btn btn-info btn-sm w-100'>Atualizar</button></a><a href=veiculo.php?id=".$row[0]. "&op=D><button type='button' class='btn btn-danger btn-sm w-100'>Deletar</button></a></td>";
        echo " </tr>";
    }   echo " </tbody>";
    echo "</table></div>";
}
