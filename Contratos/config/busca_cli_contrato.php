...
if (mysqli_affected_rows($conexao)>0) {
    ...
    while ($row=mysqli_fetch_row($result))
    {
        ...
        echo "<td id=".$row[0]." onclick=getid(".$row[0].",'".$row[7]."','".$nome."') >".$row[1]."</td>";
        ...
        echo "<td id=".$row[0]." onclick=getid(".$row[0].",'".$row[7]."','".$nome."') >".$row[9]."</td>";
        ...
        echo "<td id=".$row[0]." onclick=getid(".$row[0].",'".$row[7]."','".$nome."') >".$row[12]."</td>";
        echo "<td id=".$row[0]." onclick=getid(".$row[0].",'".$row[7]."','".$nome."') >".$row[19]."</td>";
        echo "<td id=".$row[0]." onclick=getid(".$row[0].",'".$row[7]."','".$nome."') >".$row[13]."</td>";
        echo "<td id=".$row[0]." onclick=getid(".$row[0].",'".$row[7]."','".$nome."') >".$row[14]."</td>";
        echo "<td id=".$row[0]." onclick=getid(".$row[0].",'".$row[7]."','".$nome."') >".$row[15]."</td>";
        echo "<td id=".$row[0]." onclick=getid(".$row[0].",'".$row[7]."','".$nome."') >".$row[16]."</td>";
        echo "<td id=".$row[0]." onclick=getid(".$row[0].",'".$row[7]."','".$nome."') >".$row[17]."</td>";
        echo "<td id=".$row[0]." onclick=getid(".$row[0].",'".$row[7]."','".$nome."') >".$row[18]."</td>";
