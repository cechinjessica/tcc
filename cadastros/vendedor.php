  ...
  if ($id != 0) {
    if ($op == 'A') {
      ...
      if (mysqli_error($conexao)) {
        $_SESSION['msg_erro'] = "Erro na atualização de $nome";
        echo $script;
      } else {
        $_SESSION['msg'] = "Usuário $nome atualizado com sucesso!";
      ...
      if (mysqli_affected_rows($conexao)=='1') {
        $_SESSION['msg'] = "Usuário $nome excluído com sucesso!";
        header('Location:cadastro_pessoa.php');
      } else {
        $_SESSION['msg_erro'] = "Erro na exclusão de $nome. Usuário tem contratos!";
      }
      mysqli_close($conexao);
    }
    ...
    if (mysqli_affected_rows($conexao)!=0) {
      mysqli_close($conexao);
      $_SESSION['msg_erro'] = "$cpf já foi cadastrado";
      echo $script;
      ...
      if (mysqli_affected_rows($conexao) =='1') {
        $_SESSION['msg'] = "Usuário $nome inserido com sucesso!";
        header('Location:cadastro_pessoa.php');
      } else {
